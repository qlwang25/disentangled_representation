...
from transformers.utils.activations import ACT2FN, gelu
from transformers.utils.modeling_outputs import (
...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True, *model_args, **model_kwargs):
