...
class GenerationMixin:
    """
    A class containing all of the functions supporting generation, to be used as a mixin in :class:`~transformers.PreTrainedModel`.
    """
    ...
    def _get_logits_warper(self, top_k: int = None, top_p: float = None, temperature: float = None, num_beams: int = None) -> LogitsProcessorList:
        """
        This class returns a :class:`~transformers.LogitsProcessorList` list object that contains all relevant :class:`~transformers.LogitsWarper` instances used for multinomial sampling.
        """
    ...
    def _get_logits_processor(
        ...
        """
        This class returns a :class:`~transformers.LogitsProcessorList` list object that contains all relevant :class:`~transformers.LogitsProcessor` instances used to modify the scores of the language model head.
        """
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        attribute of the same name inside the :class:`~transformers.PretrainedConfig` of the model. 
        The default values indicated are the default values of those config.
        ...
        Parameters:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
                The sequence used as a prompt for the generation. If :obj:`None` the method initializes it with :obj:`bos_token_id` and a batch size of 1.
            ...
            max_new_tokens (:obj:`int`, `optional`, defaults to None):
                ...
                Use either :obj:`max_new_tokens` or :obj:`max_length` but not both, they serve the same purpose.
            ...
            temperature (:obj:`float`, `optional`, defaults to 1.0): The value used to module the next token probabilities.
            ...
            length_penalty (:obj:`float`, `optional`, defaults to 1.0):
                ...
                model to generate shorter sequences, to a value > 1.0 in order to encourage the model to produce longer sequences.
            ...
            bad_words_ids(:obj:`List[List[int]]`, `optional`):
                ...
                should not appear in the generated text, use :obj:`tokenizer(bad_word, add_prefix_space=True).input_ids`.
            ...
            attention_mask (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
                Mask to avoid performing attention on padding token indices. Mask values are in ``[0, 1]``, 
                1 for tokens that are not masked, and 0 for masked tokens. 
            ...
            num_beam_groups (:obj:`int`, `optional`, defaults to 1):
                Number of groups to divide :obj:`num_beams` into in order to ensure diversity among different groups of beams. 
            ...
            diversity_penalty (:obj:`float`, `optional`, defaults to 0.0):
                ...
                Note that :obj:`diversity_penalty` is only effective if ``group beam search`` is enabled.
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            logits_processor (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~transformers.LogitsProcessorList`. 
                List of instances of class derived from :class:`~transformers.LogitsProcessor` used to modify the prediction scores of the language modeling head applied at each generation step.
